...
(defparameter +message-declaration-missing-initializer+ "Missing initializer in %0 declaration")
(defparameter +message-default-rest-parameter+ "Unexpected token =")
(defparameter +message-duplicate-binding+ "Duplicate binding %0")
...
(defparameter +message-for-in-of-loop-initializer+ "%0 loop variable declaration may not have an initializer")
...
(defparameter +message-redeclaration+ "%0 '%1' has already been declared")
...
(defparameter +message-unexpected-template+ "Unexpected quasi %0")
(defparameter +message-unexpected-token+ "Unexpected token %0")
(defparameter +message-unexpected-token-illegal+ "Unexpected token ILLEGAL")
(defparameter +message-unknown-label+ "Undefined label '%0'")
